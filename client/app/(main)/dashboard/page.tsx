...
function Dashboard(): JSX.Element {
  ...
  const filterGifts = (e: React.FormEvent<HTMLInputElement>) : void => {
    ...
    else setFilteredList(giftList.filter((gift) => 
  ...
  return (
    <>
    {
      ...
      </div> : <div className="flex flex-col place-items-center justify-center lg:max-w-5xl lg:w-full lg:mb-0">Please Log In</div>
    }
    </>
  );
}
